package com.example.hw03_clientdb.Network;

import android.os.AsyncTask;
import android.util.Log;
import com.example.hw03_clientdb.Custom_Adapter;
import com.example.hw03_clientdb.UserInfo;
...
public class NetworkGet extends AsyncTask<String,Void,String> {
    ...
    private URL Url;
    private String URL_Adress = "http://172.30.1.58:8888/testDB/testDB.jsp";
